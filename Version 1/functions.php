<?php
/**
 * openhouse_A2 functions and definitions
 *
...
function openhouse_a2_setup() {
	/*
		...
		* If you're building a theme based on openhouse_A2, use a find and replace
		* to change 'openhouse_a2' to the name of your theme in all the template files.
		*/
